$(document).ready(function(){
	...
	function checkEmbed(){
		...
		// 	_el.innerHTML = '<p><strong class="embed-title">The Map of E‑Commerce Thailand</strong><a href="https://ipricethailand.com" target="_blank">Powered by iPrice</a></p>';
	...
	$('.quartal_select').change(function(e){
		...
		var filename = (q != '') ? (q + '.json') : 'q3-2018.json';
